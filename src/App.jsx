  ...
  const renderAgenda = () => (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6 gap-4">
        <div>
          <h2 className="text-3xl font-bold text-zinc-100 flex items-center gap-3">
            <Calendar className="text-cyan-400" /> Full Agenda
          </h2>
          <p className="text-zinc-400 mt-1">Beheer al je gekoppelde en lokale afspraken. Habits worden hier automatisch in geplaatst.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div className="col-span-1 bg-zinc-900 rounded-3xl p-6 border border-zinc-800 shadow-xl h-fit">
